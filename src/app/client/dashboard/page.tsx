                ...
                {user.phone_number && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-semibold text-black">{user.phone_number}</p>
                    </div>
                  </div>
                )}
              </div>
          ...
          {deals.length === 0 ? (
            <Card className="shadow-sm border border-gray-200 rounded-md">
              <CardContent className="p-12 text-center bg-white">
                ...
                <h3 className="text-xl font-semibold text-black mb-2">No Policies Yet</h3>
            ...
            <div className="space-y-6">
              {deals.map((deal) => (
                <Card key={deal.id} className="shadow-sm border border-gray-200 hover:border-black transition-all rounded-md">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xl font-bold text-black">{formatCurrency(deal.monthly_premium)}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xl font-bold text-black">{formatCurrency(deal.annual_premium)}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-base font-semibold text-black">{formatDate(deal.policy_effective_date)}</p>
                        </div>
                      </div>
                      ...
                      {deal.client_address && (
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-base font-semibold text-black">{deal.client_address}</p>
                          </div>
                        </div>
                      )}
                      ...
                      {deal.date_of_birth && (
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-base font-semibold text-black">{formatDate(deal.date_of_birth)}</p>
                          </div>
                        </div>
                      )}
                    </div>

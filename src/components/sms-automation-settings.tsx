        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              When enabled, automated SMS messages are sent immediately and email notifications are delivered. When disabled, SMS messages are saved as drafts and automated emails are not sent. Individual agents can override this default.
            </p>
          </div>
          <Switch
      ...
      {smsAutoSendEnabled && (
        <div className="rounded-lg border bg-card p-6">
          <div className="mb-4">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Require manual approval for specific message types even when auto-send is enabled. Note: These overrides apply to SMS messages only.
            </p>
          </div>
      ...
      {agents && onAgentToggle && (
        <div className="rounded-lg border bg-card p-6">
          <div className="mb-4">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Individual agents can override the agency default for both SMS and email automations. When set to &quot;Agency Default&quot;, the agent follows the master toggle above.
            </p>
          </div>
